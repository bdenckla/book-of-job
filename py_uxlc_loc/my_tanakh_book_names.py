...
BK_XABA = "Habakkuk"  # guts to change it to Xabakkuk? Xabaqquq?
BK_TSEF = "Tsefaniah"
BK_XAGGAI = "Haggai"  # guts to change it to Xaggai?
...
_SHORT_TO_STD = {_bkprop_short(prop): std for std, prop in _BOOK_PROPERTIES.items()}
