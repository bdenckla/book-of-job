...
> **Canonical documentation:** The MAM-simple repo itself has a human-readable version of this guide at `../MAM-simple/doc/reading-mam-simple.md`. This file is a fuller copy of it, with local path references.
